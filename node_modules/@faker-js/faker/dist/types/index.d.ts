...
} from '@faker-js/faker/definitions';
...
export type {
    Casing, ColorFormat, ColorModule,
    /** @deprecated Use CssFunctionType instead */
    CssFunctionType as CSSFunction, CssFunctionType,
    /** @deprecated Use CssSpaceType instead */
    CssSpaceType as CSSSpace, CssSpaceType, NumberColorFormat, StringColorFormat
} from '@faker-js/faker/modules/color';
...
export type {
    ...
    LocationModule as AddressModule, LocationModule
} from '@faker-js/faker/modules/location';
...
export type {
    ...
    PersonModule as NameModule, PersonModule, SexType
} from '@faker-js/faker/modules/person';
